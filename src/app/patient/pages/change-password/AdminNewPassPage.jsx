...
import { initalFormUserNewPass, validationsFormUserNewPass } from '../../data';
import { useForm, useAuth } from '../../hooks';

export const AdminNewPassPage = () => {
  const { user, successMessage, errorMessage, isLoading, startUpdatePassProfile } = useAuth();
  ...
  const {
    ...
    onInputChange,
    onResetForm,
  } = useForm(initalFormUserNewPass, validationsFormUserNewPass);
  ...
  const handleSubmit = async (e) => {
    ...
    startUpdatePassProfile({...formState, id: user._id});
  ...
  return (
    <>
      ...
      <p className="text-base pb-6 text-center font-medium text-indigo-500">
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          >
            {!!successMessage && (
              <SuccessMessage title={false} messageSuccess={successMessage} />
            )}
